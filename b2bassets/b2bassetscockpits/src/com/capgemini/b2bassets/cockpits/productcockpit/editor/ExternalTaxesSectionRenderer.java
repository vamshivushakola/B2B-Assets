 ...
 *  
 */
package com.capgemini.b2bassets.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("b2bassetscockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("b2bassetscockpits.product.externalTaxes"));
