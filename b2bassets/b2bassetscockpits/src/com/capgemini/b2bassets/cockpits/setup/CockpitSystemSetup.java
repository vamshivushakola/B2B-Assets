 ...
 *  
 */
package com.capgemini.b2bassets.cockpits.setup;
...
import com.capgemini.b2bassets.cockpits.constants.B2bassetsCockpitsConstants;
 ...
 */
@SystemSetup(extension = B2bassetsCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(B2bassetsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(B2bassetsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						B2bassetsCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/b2bassetscockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
