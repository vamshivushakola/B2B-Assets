 ...
 *  
 */
package com.capgemini.b2bassets.core.hmc;
...
/**
 * Provides necessary meta information about the b2bassetscore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class B2bassetsCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(B2bassetsCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.capgemini.b2bassets.core.hmc.locales";
