 ...
 *  
 */
package com.capgemini.b2bassets.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(B2bassetsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(B2bassetsFulfilmentProcessConstants.PARENT_PROCESS);
