 ...
 *  
 */
package com.capgemini.b2bassets.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, B2bassetsFulfilmentProcessConstants.PARENT_PROCESS);
