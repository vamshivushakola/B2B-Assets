 ...
 *
 */
package com.capgemini.b2bassets.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('b2bassetsstorefront.generic.cms.component.controller.authorized.group')}")
