 ...
 *  
 */
package com.capgemini.b2bassets.test.setup;
...
import com.capgemini.b2bassets.test.constants.B2bassetsTestConstants;
import com.capgemini.b2bassets.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = B2bassetsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/b2bassetstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/b2bassetstest/import/reviews.impex");
			...
			importImpexFile(context, "/b2bassetstest/import/cstickets.impex");
		}
	}
}
